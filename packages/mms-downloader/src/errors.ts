...
export class MMSDownloaderError extends Error {
  constructor(message?: string) {
    super(message);
    this.name = "MMSDownloaderError";
  }
}

export class GenerationError extends MMSDownloaderError {
  link: string;
...
export class DownloadError extends MMSDownloaderError {
  constructor() {
    super();
...
export class PluginNotEnabledError extends MMSDownloaderError {
...
export class DownloadEmpty extends MMSDownloaderError {
  constructor() {
    super();
...
export class DownloadCanceled extends MMSDownloaderError {
  constructor() {
    super();
...
export class TrackError extends MMSDownloaderError {
  constructor(message?: string) {
    super(message);
