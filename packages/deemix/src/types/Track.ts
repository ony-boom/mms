...
class Track {
  ...
  remoteTrackTitleVersion: string;
  remoteTrackPreview: string;
  remoteTrackDuration: number;
  remoteTrackLink: string;
  remoteIsTrackExplicit: boolean;
  remoteArtistID: number;
  remoteArtistName: string;
  remoteAlbumID: number;
  ...
  constructor() {
    ...
    this.remoteTrackTitleVersion = "";
    this.remoteTrackPreview = "";
    this.remoteTrackDuration = 0;
    this.remoteTrackLink = "";
    this.remoteIsTrackExplicit = false;
    this.remoteArtistID = 0;
    this.remoteArtistName = "";
    this.remoteAlbumID = 0;
    this.remoteAlbumTitle = "";
    this.albumPicture = "";
    this.isRemoteTrack = false;
  }
