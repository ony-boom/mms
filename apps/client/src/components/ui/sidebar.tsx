  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "w-(--sidebar-width) relative h-svh bg-transparent transition-[width] duration-100",
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "text-nowrap group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0",
        className,
      )}
      {...props}
    />
